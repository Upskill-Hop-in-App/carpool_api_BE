...
router.put("/cl/status/:cl/:status", verifyToken, LiftController.updateLiftStatusByCode)
router.put("/cl/rating/:cl/:rating", verifyToken, LiftController.updateDriverRatingsByCode)
