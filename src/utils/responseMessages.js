export const MESSAGES = {
  ...
  /* ---------------------- Lift Success messages ---------------------- */
  CAR_CREATED: "Lift created successfully",
  CAR_RETRIEVED_BY_CODE: "Lift retrieved by code",
  CAR_UPDATED: "Lift updated successfully",
  CAR_DELETED: "Lift deleted successfully",
  CARS_RETRIEVED: "Lifts retrieved successfully",
  /* -------------------------------------------------------------------------- */
  ...
  DUPLICATE_CAR:
    "Duplicate lift code or lift name. Please use unique values.",
  NO_CARS_FOUND: "No lifts exist",
  FAILED_TO_CREATE_CAR: "Failed to create lift",
  CAR_NOT_FOUND_BY_CODE: "No lifts match the given code",
  FAILED_TO_RETRIEVE_CARS: "Failed to retrieve lifts",
  FAILED_TO_RETRIEVE_CAR_BY_CODE:
    "Failed to retrieve lift by code",
  FAILED_TO_UPDATE_CAR: "Failed to update lift",
  FAILED_TO_DELETE_CAR: "Failed to delete lift"
  /* -------------------------------------------------------------------------- */
};
